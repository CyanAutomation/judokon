 ...
 */
/**
 * Setup responsive card sizing and scroll-snap behavior for a carousel.
 *
 * Calculates an appropriate card width based on viewport size and applies
 * it via a CSS custom property. It also ensures cards use `scroll-snap`.
 *
 * @pseudocode
 * 1. Define an internal `setCardWidths` function:
 *    a. Get the current `window.innerWidth`.
