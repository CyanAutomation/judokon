...
class BattleStateMachine {
    ...
    transitionTo(newState) {
        ...
        eventBus.publish(BATTLE_EVENTS.BATTLE_STATE_CHANGED, { newState, currentRound: this.currentRound });
    ...
    _handleStateEntry(state) {
        switch (state) {
            ...
            case BATTLE_STATES.ROUND_RESOLUTION:
                eventBus.publish(BATTLE_EVENTS.ROUND_RESOLUTION_PHASE_STARTED, { round: this.currentRound });
                break;
