...
- `design/productRequirementsDocuments/prdDevelopmentStandards.md` and `design/productRequirementsDocuments/prdTestingStandards.md` now hold the consolidated deep dives previously referenced by `prdCodeStandards.md`; keep those PRDs canonical as content moves.
...
- `design/testing/classicBattleTesting.md` and similar deep dives remain valuable as implementation notes; decide per file whether to fold content into the owning PRD or keep them as linked appendices with a clear authority statement. The former `design/codeStandards/*.md` material now lives in the PRDs above.
...
- `docs/testing-modes.md` (now covered by `prdTestMode.md#mode-interactions-and-automation-hooks`), `docs/testing-guide.md` (retired), `docs/TestValuePolicy.md` (retired), and the retired `design/codeStandards/evaluatingPlaywrightTests.md` / `design/codeStandards/evaluatingUnitTests.md` → consolidate into `prdTestingStandards.md` with clear subsections for agent vs human workflows.
...
- `docs/testing-modes.md` -> `prdTestMode.md#mode-interactions-and-automation-hooks` + `prdTestingStandards.md`
