...
|    6 | `win-target-sync.spec.js`               |      5       | COMPLETED ✅ |   2    |     1     |     1     |     0      |  1   | 19,014 → 6,706 | Switched to commonSetup, retained necessary __FF_OVERRIDES for modal display, corrected expectation from Round 1 to Round 0 (target syncs without starting battle). Duration improved significantly, test now passes reliably. |
