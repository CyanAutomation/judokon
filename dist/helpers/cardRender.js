...
export function generateCardPortrait(judoka) {
    const portraitUrl = judoka && judoka.id ? `/judokaPortraits/judokaPortrait-${judoka.id}.png` : PLACEHOLDER_PORTRAIT;
    return `
    <div class="card-portrait">
      <img src="${portraitUrl}" alt="${getValue(judoka === null || judoka === void 0 ? void 0 : judoka.name, "Judoka")} ${getValue(judoka === null || judoka === void 0 ? void 0 : judoka.surname, "")}'s portrait" onerror="this.src='${PLACEHOLDER_PORTRAIT}'">
    </div>
  `;
}
/**
...
export function generateCardStats(judoka) {
    if (!(judoka === null || judoka === void 0 ? void 0 : judoka.stats))
        return `<div class="card-stats">No stats available</div>`;
...
export function generateCardSignatureMove(judoka, gokyo) {
    var _a;
    const signatureMoveId = judoka === null || judoka === void 0 ? void 0 : judoka.signatureMoveId;
    ...
    const techniqueName = (_a = technique === null || technique === void 0 ? void 0 : technique.name) !== null && _a !== void 0 ? _a : "Unknown";
    return `
