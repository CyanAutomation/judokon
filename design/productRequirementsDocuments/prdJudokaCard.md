...
- Maintain **≥44px touch target** size for all clickable areas to meet WCAG guidelines. See [UI Design Standards](../prdDevelopmentStandards.md#accessibility--ux-expectations).
...
- [ ] 2.4 Ensure ≥44px touch targets for interactive elements (see [UI Design Standards](../prdDevelopmentStandards.md#accessibility--ux-expectations)).
