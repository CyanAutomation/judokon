...
- Entry points are represented on the map as clickable, animated hotspots (≥44px). See [UI Design Standards](../prdDevelopmentStandards.md#accessibility--ux-expectations).
