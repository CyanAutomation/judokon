...
- Touch Targets: Cards and buttons sized ≥44px for accessibility compliance. See [UI Design Standards](prdUIDesignSystem.md#4-accessibility-standards-p1) for full guidelines.
...
- [x] 2.0 Responsive Layout and Accessibility
  ...
  - [x] 2.2 Ensure touch targets ≥44px and WCAG 4.5:1 contrast compliance (see [UI Design Standards](prdUIDesignSystem.md#4-accessibility-standards-p1))
