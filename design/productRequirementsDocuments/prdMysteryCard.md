...
## Mystery Card Reveal State Machine

**Opponent Card Reveal Sequence**:
...
**Mystery Card Visibility Timeline**:
...
- `tests/helpers/battleEngineFacade.test.js` — Reveal animation tests
