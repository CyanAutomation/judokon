...
| File size         | <19.8mb total JSON size to ensure fast client-side loading                                                               |
...
- The vector database file size remains under 19.8mb for fast client-side loading.
...
- [x] 2.0 Implement Client-Side Embedding Store
  ...
  - [x] 2.2 Ensure total file size stays below the 19.8mb threshold
