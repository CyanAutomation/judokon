...
**Test Coverage**: Verified by: [tests/helpers/battleScoreboard.ordering.test.js](../../tests/helpers/battleScoreboard.ordering.test.js) — validates stale-check ordering and ordering/idempotency guards against duplicate/out-of-order events; [tests/components/Scoreboard.test.js](../../tests/components/Scoreboard.test.js) — tests state transitions and value-only update paths
