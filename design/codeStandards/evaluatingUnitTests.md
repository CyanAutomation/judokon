...
```json
{
  ...
  "policy": {
    "file": "design/productRequirementsDocuments/prdTestingStandards.md#unit-test-quality-standards",
    "key_rules": [
...
- **Contributor Policy**: `design/productRequirementsDocuments/prdTestingStandards.md#unit-test-quality-standards`
