...
describe("countdown resets after stat selection", () => {
  ...
  it("starts a visible countdown after stat selection", async () => {
    ...
    console.log("DEBUG: timerTexts =", timerTexts);
    console.log("DEBUG: snackbarTexts =", snackbarTexts);
    ...
    console.log("DEBUG: fallbackReadings =", fallbackReadings);
    console.log("DEBUG: hasTimerPattern =", hasTimerPattern);
    ...
    console.log("DEBUG: hasDecrease =", hasDecrease);

    expect(samples.length).toBeGreaterThanOrEqual(2);
    const hasConsistentPositiveValue =
      samples.length >= 2 && samples.every((v) => v > 0 && v === samples[0]);
    console.log("DEBUG: hasConsistentPositiveValue =", hasConsistentPositiveValue);
