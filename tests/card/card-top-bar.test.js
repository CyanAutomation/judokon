 ...
 * @returns {any}
 */
normalizeHtml = html => html.replace(/>\s+</g, "><").replace(/></g, "> <").replace(/\s+/g, " ").trim();
const judoka = {
  firstname: "Clarisse",
  surname: "Agbegnenou",
  countryCode: "fr"
...
describe("createFlagImage", () => {
  it("should render flag image with correct src and alt attributes", () => {
    ...
    expect(flagImage.outerHTML).toContain(`<img src="https://flagcdn.com/w320/us.png" alt="United States flag"`);
  });
});