...
describe("createScrollButton", () => {
  ...
  it("should handle edge cases gracefully when container is null", () => {
    ...
    describe("generateCardStats", () => {
      ...
      it("should throw an error if stats is null or undefined", () => {
        const cardWithNullStats = { stats: null };
        const cardWithUndefinedStats = { stats: undefined };

        expect(() => generateCardStats(cardWithNullStats)).toThrowError("Stats object is required");
        expect(() => generateCardStats(cardWithUndefinedStats)).toThrowError(
